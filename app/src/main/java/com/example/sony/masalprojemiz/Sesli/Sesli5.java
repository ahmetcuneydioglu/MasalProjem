 ...
 */
public class Sesli5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sesli5);
        ...
        songName.setText("Çapalý Çicekler");
        media1=MediaPlayer.create(this,R.raw.capailecicekler);
